...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000770a2abd000000005512ee69(
...
class phpbbtemplatetwiglexer_00000000770a2abd000000005512ee69 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5931370532fbc798913092 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5931370532fbc402317294 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5931370532fbc447426787 = array(
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, 'set_environment', array('env' => $env), $this->initializer5931370532fbc402317294);

        return $this->valueHolder5931370532fbc798913092->set_environment($env);
    }
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5931370532fbc402317294);

        return $this->valueHolder5931370532fbc798913092->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5931370532fbc402317294);

        return $this->valueHolder5931370532fbc798913092->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5931370532fbc402317294 = $initializer;
    }
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__get', array('name' => $name), $this->initializer5931370532fbc402317294);

        if (isset(self::$publicProperties5931370532fbc447426787[$name])) {
            return $this->valueHolder5931370532fbc798913092->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5931370532fbc798913092;
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5931370532fbc402317294);
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__isset', array('name' => $name), $this->initializer5931370532fbc402317294);
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__unset', array('name' => $name), $this->initializer5931370532fbc402317294);
    ...
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__clone', array(), $this->initializer5931370532fbc402317294);

        $this->valueHolder5931370532fbc798913092 = clone $this->valueHolder5931370532fbc798913092;
    }

    public function __sleep()
    {
        $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, '__sleep', array(), $this->initializer5931370532fbc402317294);

        return array('valueHolder5931370532fbc798913092');
    }
    ...
    {
        return $this->initializer5931370532fbc402317294;
    }
    ...
    {
        return $this->initializer5931370532fbc402317294 && $this->initializer5931370532fbc402317294->__invoke($this->valueHolder5931370532fbc798913092, $this, 'initializeProxy', array(), $this->initializer5931370532fbc402317294);
    }
    ...
    {
        return null !== $this->valueHolder5931370532fbc798913092;
    }
    ...
    {
        return $this->valueHolder5931370532fbc798913092;
    }
