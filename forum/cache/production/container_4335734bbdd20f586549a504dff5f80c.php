...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006034f2ab00000000541146a5(
...
class phpbbtemplatetwiglexer_000000006034f2ab00000000541146a5 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder593136b112508087556681 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer593136b112508878772398 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties593136b112508595747194 = array(
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, 'set_environment', array('env' => $env), $this->initializer593136b112508878772398);

        return $this->valueHolder593136b112508087556681->set_environment($env);
    }
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer593136b112508878772398);

        return $this->valueHolder593136b112508087556681->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer593136b112508878772398);

        return $this->valueHolder593136b112508087556681->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer593136b112508878772398 = $initializer;
    }
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__get', array('name' => $name), $this->initializer593136b112508878772398);

        if (isset(self::$publicProperties593136b112508595747194[$name])) {
            return $this->valueHolder593136b112508087556681->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder593136b112508087556681;
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer593136b112508878772398);
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__isset', array('name' => $name), $this->initializer593136b112508878772398);
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__unset', array('name' => $name), $this->initializer593136b112508878772398);
    ...
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__clone', array(), $this->initializer593136b112508878772398);

        $this->valueHolder593136b112508087556681 = clone $this->valueHolder593136b112508087556681;
    }

    public function __sleep()
    {
        $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, '__sleep', array(), $this->initializer593136b112508878772398);

        return array('valueHolder593136b112508087556681');
    }
    ...
    {
        return $this->initializer593136b112508878772398;
    }
    ...
    {
        return $this->initializer593136b112508878772398 && $this->initializer593136b112508878772398->__invoke($this->valueHolder593136b112508087556681, $this, 'initializeProxy', array(), $this->initializer593136b112508878772398);
    }
    ...
    {
        return null !== $this->valueHolder593136b112508087556681;
    }
    ...
    {
        return $this->valueHolder593136b112508087556681;
    }
